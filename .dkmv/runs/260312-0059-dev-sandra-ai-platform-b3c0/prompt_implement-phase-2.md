You are implementing Phase 2: core engine.
...
- `phase2_core_engine.md` — YOUR phase document with specific tasks
...
1. Read `.agent/impl_docs/phase2_core_engine.md` carefully — understand every task
